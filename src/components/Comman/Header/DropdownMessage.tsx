    ...
    return (
        ...
        >
            <li className="relative">
                ...
                >
                    <span
                        className={`z-1 bg-meta-1 absolute -right-0.5 -top-0.5 size-2 rounded-full ${
                            notifying === false ? 'hidden' : 'inline'
                        }`}
                    >
                        <span className="-z-1 bg-meta-1 absolute inline-flex size-full animate-ping rounded-full opacity-75"></span>
                    </span>
