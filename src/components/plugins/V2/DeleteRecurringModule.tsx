          ...
          <div className="plugin-body">
            ...
            <div className="setforget">
              ...
              <div className="cont font24">
                <h5>Delete recurring deposits rule?</h5>
              </div>
            </div>
            <p className="black text-left">Are you sure you want to delete this recurring deposit rule from your
            ...
            <div className="bgwithicon">
              ...
              <p>You will miss out on an extra <span>1%</span> cash reward on AutoStash deposits</p>
            </div>
          </div>
          <div className="plugin-footer">
            <div className="footer-btns">
              <a className="submitbtn cancel">Cancel</a>
              <Link to="#pause-recurring-rule" className="submitbtn delete">Delete</Link>
            </div>
          </div>
        </div>
      </div>
...
export default DeleteRecurringModule