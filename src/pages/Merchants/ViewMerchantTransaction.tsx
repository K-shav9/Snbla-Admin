...
import { getTransactionsByMerchantId } from "../../actions/merchant";
...
export const ViewMerchantTransaction: React.FC<TransactionDetailsProps> = ({
  transaction,
  loading,
  onPageChange,
}) => {
 ...
 const [pagination, setPagination] = useState({
  ...
  const handleViewTransaction = (record: any) => {
    ...
    if (record?.id) {
     ...
     navigate("/admin/merchant/transaction/details", {
       ...
       .then((response: any) => {
        ...
        const csvData = response?.data?.map((transaction) => {
          ...
          return {
            ...
            "Reward (%)": transaction?.reward, // ✅ Matches UI calculation
