...
const ViewWalletDetails = () => {
  ...
  const location = useLocation(); // Access location data
   const [walletData, setwalletData] = useState(location.state?.walletData || {}); 
      ...
      <div className="form-wrapper">
        <div className="row mb-4">
          <div className="col-lg-6 col-sm-12">
            <p>
              <strong>Name:</strong> {walletData?.user?.name || "N/A"}
            </p>
          </div>
          <div className="col-lg-6 col-sm-12">
            <p>
              <strong>Email:</strong> {walletData?.user?.email || "N/A"}
            </p>
          </div>
        </div>
        <div className="row mb-4">
        ...
        <div className="row mb-4">
          <div className="col-lg-6 col-sm-12">
            <p>
              ...
              {walletData?.merchants?.businessName || "N/A"}
            </p>
          </div>
          <div className="col-lg-6 col-sm-12">
            <p>
              <strong>Description:</strong>{" "}
              {walletData?.merchants?.description || "N/A"}
            </p>
          </div>
        </div>
        <div className="row mb-4 mt-20">
          <div className="col-lg-6 col-sm-12">
            <p>
              <strong>Voucher Code:</strong> {walletData?.voucherCode}
            </p>
          </div>
          <div className="col-lg-6 col-sm-12">
            <p>
